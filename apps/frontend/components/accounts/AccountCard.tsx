...
export default function AccountCard({ account }: { account: any }) {
  ...
  return (
    <Link href={`/home?wallet=eth:${contractAddr}`}>
      <div className="flex items-center justify-between p-4 mt-2 border border-border rounded-xl bg-bgSubtle hover:bg-bgMoreSubtle transition-colors shadow-xl cursor-pointer">
